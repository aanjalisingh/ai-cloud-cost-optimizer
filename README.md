...
git clone https://github.com/aanjalisingh/ai-cloud-cost-optimizer.git
...
A cloud-based data analytics platform using Python backend, PostgreSQL database, and Elasticsearch for search. Requires monitoring, alerting, and scalability. Monthly budget is 80,000 INR.
